...
$urlMenu = [
    ...
    "horariosDisponibles" => "administrative/attendance/schedulesDisp.php?id=$user_active",
...
$supportLists = '
<p class="d-inline-flex gap-1">
<a class="btn btn-primary" href="?opcion=catalogos" role="button" aria-expanded="false">
&nbsp;&nbsp; <i class="bi bi-list-columns-reverse"></i> &nbsp; Catálogos
</a>
</p>
';
$supportAdmin = '
<p class="d-inline-flex gap-1">
<a class="btn btn-primary" href="?opcion=usuarios" role="button" aria-expanded="false">
&nbsp;&nbsp; <i class="bi bi-pc-display-horizontal"></i> &nbsp; Administrativos
</a>
</p>
';
$supportAcade = '
<p class="d-inline-flex gap-1">
<a class="btn btn-primary" href="?opcion=docentes" role="button" aria-expanded="false">
...
$supportRegAnti = '
<p class="d-inline-flex gap-1">
<a class="btn btn-primary" href="?opcion=registrarAnticipadas" role="button" aria-expanded="false">
&nbsp;&nbsp; <i class="bi bi-clipboard2-fill"></i> &nbsp; Usuarios sin Vacaciones
</a>
</p>
';
$supportValAnti = '
<p class="d-inline-flex gap-1">
<a class="btn btn-primary" href="?opcion=vacacionesAnticipadas" role="button" aria-expanded="false">
&nbsp;&nbsp; <i class="bi bi-airplane-fill"></i> &nbsp; Vacaciones Anticipadas
</a>
</p>
';

$schedules_assign = '<p class="d-inline-flex gap-1">
<a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseAssign" role="button" aria-expanded="false" aria-controls="collapseAssign">
<i class="bi bi-clock-fill"></i> &nbsp; Asignación de Horarios
</a>
</p>
<div class="collapse" id="collapseAssign">
<div class="list-group list-group-flush">
<a href="?opcion=asignarHorario" type="button" class="list-group-item list-group-item-action list-group-item-primary"><b>Asignar Horario</b></a>
<a href="?opcion=horariosDisponibles" type="button" class="list-group-item list-group-item-action list-group-item-primary"><b>Horarios Disponibles</b></a>
</div>
</div>';
...
<li class="nav-item text-white"><p class="d-inline-flex gap-1"> &nbsp; 
<i class="bi bi-gear-wide"></i> &nbsp; Administración</p>
</li>
<li class="nav-item">
' . $supportLists . '
</li>
