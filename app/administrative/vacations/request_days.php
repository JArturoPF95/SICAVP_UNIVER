        ...
        while ($row_getDays = $restult_getCalendarDays->fetch_assoc()) {
            ...
            require_once 'process/request_days.php';
                ...
                if ($result_valRequestDays->num_rows > 0) {
                    ...
                    if ($days_request <= ($days_left - $days_used) || $termSel != $term) {

                        //Validamos si fueron anticipados
                        ...
                        if ($resultValAnti -> num_rows > 0) {
                            while ($rowValAnti = $resultValAnti -> fetch_assoc()) {
                                ...
                                $sqlUpdateAnti = "UPDATE vacation_anticipated SET REQUEST_FLAG = '1' WHERE ID_NOM = '$user_active';";
                    ...
                    ?>
                        ...
                        <tbody class="text-center <?php echo $background ?>">
                            <tr>
                                ...
                                ?>
                                    <td scope="col">
                                        <a href="process/removeVac.php?id=<?php echo $myRequest_Id ?>" type="button" class="btn btn-sm btn-outline-secondary disabled">
                                            Eliminar
                                        </a>
                                    </td>
                                <?php
