...
if ($antiquity_years -> y < 1) {
    $yrs = '';
} elseif($antiquity_years -> y == 1) {
    $yrs = $antiquity_years -> y . " año ";
} else {
...
if ($antiquity_years -> m < 1) {
    $mth = '';
} elseif ($antiquity_years -> m == 1) {
    $mth = $antiquity_years -> m . " mes ";;
} else {
    $mth = $antiquity_years -> m . " meses ";
}

if ($antiquity_years -> d < 1) {
    $dys = '';
} elseif ($antiquity_years -> d == 1) {
    $dys = $antiquity_years -> d . " día ";
} else {
    $dys = $antiquity_years -> d . " días ";
}



$anti_yrs = $yrs . $mth . $dys;
...
if ($days_law == 0 || $days_left == 0) {  //Se valida que sus días pendientes o por ley sean mayores a 0
