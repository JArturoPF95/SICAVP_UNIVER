...
$sqlUserLock = "UPDATE users SET PASSWORD = '7RicN6.i047hW8pOr', PASS_TEMP = '$idUser', SEPARATION_FLAG = '1', FLAG_CONFIRM = '0', EMAIL = '', MODIFIED_BY = '$user_active', MODIFIED_DATE = NOW()  WHERE SICAVP_USER = '$idUser'";
