                ...
                <div class="container d-flex flex-wrap justify-content-center">
                    ...
                    <div class="text-end">
                        ...
                        <a href="user.php" class="btn btn-primary d-inline-flex align-items-center" type="button">
                            Nuevo Usuario &nbsp; <i class="bi bi-person-fill-gear"></i>
                        </a>
                        <!--Nuevo Empleado-->
                        <a href="newEmp.php" class="btn btn-primary d-inline-flex align-items-center" type="button">
                            Nuevo Empleado &nbsp; <i class="bi bi-person-badge-fill"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <table id="myTable" class="table table-primary table-hover table-bordered table-sm" style="font-size: 13px;">
                <thead class="text-center">
                    <tr>
                        ...
                        <th scope="col" class="text-white">ID Biotime</th>
                ...
                ?>
                    <tbody>
                        <tr <?php echo $bg ?>>
                            ...
                            <td><?php if ($rowUsers['ID_BIOUNIVER'] == null) {
                                echo '-';
                            } else {
                                echo $rowUsers['ID_BIOUNIVER'];
                            } ?></td>
                            <td><?php echo $rowUsers['CITY'] . ' - ' . $rowUsers['NOM_SESION'] ?></td>
                            ...
                            <td>
                                <div class="btn-group dropstart">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php if ($rowUsers['SEPARATION_FLAG'] === '0') { ?>
                                            <li class="dropdown-item"><a class="dropdown-item" href="administrative/user_reset.php?id=<?php echo $rowUsers['SICAVP_USER'] ?>"><i class="bi bi-person-fill-gear"></i> &nbsp; Reestablecer Acceso</a></li>
                                            <?php if ($rowUsers['ACCESS_LEVEL'] === '1'|| $rowUsers['ACCESS_LEVEL'] === '2') {?>
                                                <li class="dropdown-item"><a class="dropdown-item" href="administrative/vacations.php?id=<?php echo $rowUsers['SICAVP_USER'] ?>"><i class="bi bi-luggage-fill"></i> &nbsp; Vacaciones</a></li>
                                                <li class="dropdown-item"><a class="dropdown-item" href="administrative/updateBio.php?id=<?php echo $rowUsers['SICAVP_USER'] ?>"><i class="bi bi-fingerprint"></i> &nbsp; Actualizar ID Biotime</a></li>
                                                <li class="dropdown-item"><a class="dropdown-item" href="administrative/user_update.php?id=<?php echo $rowUsers['SICAVP_USER'] ?>"><i class="bi bi-person-lines-fill"></i> &nbsp; Actualizar Usuario</a></li>
                                            <?php } elseif ($rowUsers['ACCESS_LEVEL'] === '3') { ?>
                                                <li class="dropdown-item"><a class="dropdown-item" href="administrative/user_update_sup.php?id=<?php echo $rowUsers['SICAVP_USER'] ?>"><i class="bi bi-person-lines-fill"></i> &nbsp; Actualizar Usuario</a></li>
                                            <?php } ?>
                                            <li class="dropdown-item"><a class="dropdown-item" href="administrative/user_lock.php?id=<?php echo $rowUsers['SICAVP_USER'] ?>"><i class="bi bi-person-fill-lock"></i> &nbsp; Bloquear Usuario</a></li>
                                        <?php } elseif ($rowUsers['SEPARATION_FLAG'] === '1') { ?>
                                        <li class="dropdown-item"><a class="dropdown-item" href="administrative/user_unlock.php?id=<?php echo $rowUsers['SICAVP_USER'] ?>"><i class="bi bi-person-fill-up"></i> &nbsp; Desbloquear Usuario</a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </td>
