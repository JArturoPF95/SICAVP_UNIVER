...
$sqlDepartment = "SELECT * FROM code_department DEP INNER JOIN code_area ARE ON ARE.CODE_AREA = DEP.CODE_AREA WHERE CODE_DEPRTMENT != '000'";
...
<body>
    ...
    <h4 class="my-3">Departamentos Administrativos</h4>
        ...
        ?>
            <table id="myTable" class="table table-hover table-bordered table-sm" style="font-size: 13px;">
                ...
                <tbody class="text-center">
                    ...
                    ?>
                        <tr>
                            <td><?php echo $rowDepartment['CODE_DEPRTMENT'] ?></td>
                            <td><?php echo $rowDepartment['DEPARTMENT'] ?></td>
                            <td><?php echo $rowDepartment['NAME_AREA'] ?></td>
                        </tr>
                    <?php
                    }
                    ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Excel Departamentos Nom2001</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="csvLoads/loadDepartment.php" method="post" enctype="multipart/form-data">
