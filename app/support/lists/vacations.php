                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0"> <!-- Div Semana Santa -->
                                <div class="card text-bg-info">
                                    <div class="card-body text-center text-white">
                                        ...
                                        <?php
                                        $sqlValSS = "SELECT DISTINCT ADDDATE(REQUEST_DATE, INTERVAL 15 DAY) REQUEST_DATE, START_DATE, END_DATE FROM vacation_request WHERE COMMENTS = 'Semana Santa' AND REQUEST_TERM = '$year' AND START_DATE <> '0000-00-00' AND END_DATE <> '0000-00-00'";
                            ...
                            <div class="col-sm-6"> <!--Div Navidad -->
                                <div class="card text-bg-info">
                                    <div class="card-body text-center text-white">
                                        ...
                                        <?php
                                        $sqlValFA = "SELECT DISTINCT ADDDATE(REQUEST_DATE, INTERVAL 15 DAY) REQUEST_DATE, START_DATE, END_DATE FROM vacation_request WHERE COMMENTS = 'Navidad - Fin de Año' AND REQUEST_TERM = '$year' AND START_DATE <> '0000-00-00' AND END_DATE <> '0000-00-00'";
