...
$sqlSesions = "SELECT * FROM code_sesion WHERE CODE_SESION_NOM != '00000'";
$resultSessions = $mysqli->query($sqlSesions);
$alert = '
...
<body>
    ...
    <h4 class="my-3">Campus Administrativos</h4>
            ...
            <table id="myTable" class="table table-hover table-bordered table-sm" style="font-size: 13px;">
                <thead class="text-center">
                    <tr>
                        ...
                        <th scope="col" class="text-white table-primary">País</th>
                        <th scope="col" class="text-white table-primary">Ciudad</th>
                    </tr>
                </thead>
                <tbody class="text-center">
                    <?php
                    while ($rowSessions = $resultSessions->fetch_assoc()) {
                    ?>
                        <tr>
                            <td><?php echo $rowSessions['CODE_SESION_NOM'] ?></td>
                            <td><?php echo $rowSessions['NOM_SESION'] ?></td>
                            <td><?php echo $rowSessions['COUNTRY'] ?></td>
                            <td><?php echo $rowSessions['CITY'] ?></td>
                        </tr>
                    <?php
                    }
                    ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Excel Campus Nom2001</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="csvLoads/loadSesions.php" method="post" enctype="multipart/form-data">
