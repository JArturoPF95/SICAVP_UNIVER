...
$sqlDelete = "DELETE FROM code_department";
if ($mysqli->query($sqlDelete)) {
    ...
    if (isset($_FILES['archivo_xlsx'])) {
        ...
        if ($archivo_xlsx['error'] === UPLOAD_ERR_OK) {
            ...
            $encabezados[0] = 'CODE_DEPRTMENT';
            $encabezados[1] = 'DEPARTMENT';
            $encabezados[2] = 'CODE_AREA';
            ...
            try{
                ...
                while (($fila = fgetcsv($csvFile)) !== false) {
                    ...
                    $insert = "INSERT IGNORE INTO code_department ($columnas) VALUES ('$valores');";
                    if ($mysqli->query($insert)) {
                        $message = 'Layout de Departamentos Convertido y Cargado correctamente.';
                        $icon = 'success';
                    } else {
...
<head>
    ...
    <title>Envío de Departamentos</title>
...
<body>
    ...
    <script type="text/javascript">
        swal({
            ...
            window.location = "../department.php?id=<?php echo $user_active ?>";
        });
    </script>
