...
$sqlDelete = "DELETE FROM code_payroll";
        ...
        if ($archivo_xlsx['error'] === UPLOAD_ERR_OK) {
            ...
            try {
                ...
                while (($fila = fgetcsv($csvFile)) !== false) {
                    ...
                    $insert = "INSERT IGNORE INTO code_payroll ($columnas) VALUES ('$valores');";
                    if ($mysqli->query($insert)) {
                        $message = 'Layout de Tipos de Nómina Convertido y Cargado correctamente.';
                        $icon = 'success';
                    } else {
                        $message = 'Error cargando Tipos de Nómina';
                        $icon = 'error';
                    }
                }
...
<head>
    ...
    <title>Envío de Tipos de Nómina</title>
...
<body>
    ...
    <script type="text/javascript">
        swal({
            title: "Carga de Tipos de Nómina",
