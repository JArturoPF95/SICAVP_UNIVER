...
$sqlArea = "SELECT * FROM code_area WHERE CODE_AREA != '000'";
...
<body>
    ...
    <h4 class="my-3">Áreas Administrativas</h4>
            ...
            <table id="myTable" class="table table-hover table-bordered table-sm" style="font-size: 13px;">
                ...
                <tbody class="text-center">
                    ...
                    while ($rowArea = $resultArea->fetch_assoc()) {
                        $codeArea = $rowArea['CODE_AREA'];
                        $nameArea = $rowArea['NAME_AREA'];
                    ?>
                        <tr>
                            <td><?php echo $codeArea ?></td>
                            <td><?php echo $nameArea ?></td>
                        </tr>
                    <?php
                    }
                    ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Excel Áreas Nom2001</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="csvLoads/loadArea.php" method="post" enctype="multipart/form-data">
