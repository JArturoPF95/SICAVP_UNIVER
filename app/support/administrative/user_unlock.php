...
$sql_userReturn = "UPDATE users SET SEPARATION_FLAG = '0', PASSWORD = '', PASS_TEMP = '$passNew', MODIFIED_BY = '$user_active', MODIFIED_DATE = NOW()  WHERE SICAVP_USER = '$idUser'";
if ($mysqli->query($sql_employedReturn) === TRUE && $mysqli->query($sql_userReturn)) {
