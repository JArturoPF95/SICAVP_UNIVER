    ...
    <div>
        <div class="container" style="height: 10%;">
            <table class="table" style="width: 100%;">
                <tbody>
                    <tr>
                        <td style="width: 10%"><img src="https://sicavp.univer-gdl.info/static/img/2.png" style="width: 100px; height: 25px;" alt=" " srcset=" "><img></td>
                        <td style="width: 10%"></td>
                        <td style="width: 60%"><span style="color:silver">FORMATO PARA SOLICITAR VACACIONES</span></td>
                        <td style="width: 10%"></td>
                        <td style="width: 10%"><img src="https://sicavp.univer-gdl.info/static/img/logo_univer.png" style="width: 100px; height: 50px;" alt=" " srcset=" "></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="container" style="height: 50%;">
            ...
            if ($result_infoPDF->num_rows > 0) {
                while ($row_PDF = $result_infoPDF->fetch_assoc()) {
                    $infoPDF_name = $row_PDF['NAME_EMP'];
                    $infoPDF_idNom = $row_PDF['ID_NOM'];
                        ...
                        <table class="table" style="width: 100%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 60%; border-bottom: solid; border-color: #000; border-width: 0.5px; text-align: center;"><?php echo $infoPDF_name ?></td>
                                    <td style="width: 5%;"></td>
                                    <td style="width: 15%;">No. Empleado: </td>
                                    <td style="width: 10%; border-bottom: solid; border-color: #000; border-width: 0.5px; text-align: center;"><?php echo $infoPDF_idNom ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
