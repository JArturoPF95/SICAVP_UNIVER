...
$sql_userSeparation = "UPDATE users SET SEPARATION_FLAG = '1', PASSWORD = 'IV6OHJ.KQixrNhinWCsJbq', MODIFIED_BY = '$user_active', MODIFIED_DATE = NOW() WHERE SICAVP_USER = '$idUser'";
