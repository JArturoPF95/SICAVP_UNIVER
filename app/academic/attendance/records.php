                ...
                <tbody class="table-light">
                    ...
                    if ($result_attendance->num_rows > 0) {
                        while ($row_attendance = $result_attendance->fetch_assoc()) {
                            ...
                            $attendance_program = $row_attendance['PROGRAM_DESC'];
                            $attendance_curriculum = $row_attendance['FORMAL_TITLE'];
                            $attendance_event = $row_attendance['PUBLICATION_NAME_1'];
                            $attendance_section = $row_attendance['SECTION'];
                            $attendance_serialID = $row_attendance['SERIAL_ID'];
                            $attendance_room = $row_attendance['ROOM_NAME'];
                    ...
                    ?>
                            ...
                            <tr class="text-center">
                                ...
                                <td><?php echo $attendance_section ?></td>
                                <td><?php echo $attendance_serialID ?></td>
