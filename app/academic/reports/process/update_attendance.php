...
if ($justified == 'Y') {
    $sql_valJustify = "UPDATE academic_attendance SET JUSTIFY = '$justified', TINC = 21 WHERE AttendanceId = '$attendance'";
...
<body>
    ...
    <script type="text/javascript">
        swal({
            ...
            window.location = "../events.php?id=<?php echo $user_active ?>&d=<?php echo $dayS ?>&p=<?php echo $proS ?>";
        });
    </script>
