...
$userClinic = '';
$flagClinic = '0'; //Bandera para validar materias Campos clínicos o presenciales de campus: 0:No materias clínicas, 1:Tiene materias clínicas
                    ...
                    <footer>
                        <ul class="nav justify-content-center">
                            <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">
                                    <img src="../static/img/cropped-univer_white.webp" alt="" srcset="" style="width: auto; height: 60px;">
                                </a></li>
                        </ul>
                        <p class="text-center text-light">&copy; 2025 Dirección de Tecnologías de la Información</p>
